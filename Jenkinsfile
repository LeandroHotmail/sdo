    ...
    // -------------------------------------------------------------------------
 	...
 	withEnv(["HOME=${env.WORKSPACE}"]) {	
		...
		stage('Authorize to Salesforce') {
		    ...
		    rc = command "${toolbelt}/sfdx force:auth:jwt:grant --clientid 3MVG9Kip4IKAZQEXMiOBtPOX__bjAFLq3oSppEvk9LBBjY_JM2v_6k4tdjKIz291udcDtPsdTYu90EjVQuOJP --jwtkeyfile /Users/ldecarvalho/dev/jenkins/leandro/server.key --username ldecarvalho@ldecarvalho-20200713.demo --instanceurl https://login.salesforce.com --setdefaultdevhubusername"
            if (rc != 0) {
